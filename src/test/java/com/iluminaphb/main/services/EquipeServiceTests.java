...
public class EquipeServiceTests {
    ...
    @Test
    @DisplayName("Deve adicionar funcionário na equipe")
    void deveAdicionarFuncionariosNaEquipe() {
        
    }

    @Test
    @DisplayName("Deve remover funcionário da equipe")
    void deveRemoverFuncionariosDaEquipe() {
